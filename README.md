...
**시장 구조 변화에 대응하는 리스크 관리 중심 포트폴리오 전략**입니다.
...
본 전략은 수익 극대화보다는  
**드로우다운 통제 및 리스크 조정 성과 개선**을 목표로 합니다.
